...
## Overview
This directory contains data for the NereidaPipeline marine biodiversity analysis.

## Data Structure
- `marine_biodiversity.duckdb`: Consolidated database with all processed data
- `raw/`: Original unprocessed data files
- `processed/`: Cleaned and analyzed data

## Raw Data Sources
- OBIS occurrence data: Retrieved using robis package
- GBIF occurrence data: Retrieved using rgbif package
- Genomic data: Retrieved using biomartr package
- Environmental data: Various sources (depth, salinity, SST)

## Regenerating Data
All raw data can be regenerated by running the pipeline:
...
Some files are excluded from version control due to size:
- Raw CSV files (>10MB each)
- Genomic sequence files (>100MB)
- Environmental raster files (>50MB)
